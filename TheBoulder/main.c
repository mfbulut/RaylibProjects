...
int main() {
    ...
    font24x = LoadFontEx("bin/assets/Monocraft.ttf", 24, NULL, 0);
    font48x = LoadFontEx("bin/assets/Monocraft.ttf", 48, NULL, 0);
    font96x = LoadFontEx("bin/assets/Monocraft.ttf", 96, NULL, 0);
    #else
    font24x = LoadFontEx("assets/Monocraft.ttf", 24, NULL, 0);
    font48x = LoadFontEx("assets/Monocraft.ttf", 24, NULL, 0);
    font96x = LoadFontEx("assets/Monocraft.ttf", 96, NULL, 0);
    #endif
