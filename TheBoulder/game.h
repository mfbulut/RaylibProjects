...
void InitGame() {
    ...
    jumpSound = LoadSound("bin/assets/jump.wav");
    coinSound = LoadSound("bin/assets/coin.qoa");
    music = LoadMusicStream("bin/assets/song.ogg");
    #else
    jumpSound = LoadSound("assets/jump.wav");
    coinSound = LoadSound("assets/coin.qoa");
    music = LoadMusicStream("assets/song.ogg");
    #endif

    SetSoundVolume(jumpSound, settings.volume / 100.0F);
    SetSoundVolume(coinSound, settings.volume / 100.0F);
    SetMusicVolume(music, settings.music / 100.0F);
    music.looping = true;
